                             ...
                             {initial_update_rate_hz, 50.f}} // will be initialized correctly when params are loaded
{
    ...
    if(char const* tmp = std::getenv("HOME")){
        string home_p(tmp);
        _config_path = home_p + "/UWSim/src/underwater_simulation/dynamics_stack/unit_sim_dynamics_only/Install/config/";
        _data_path = home_p + "/UWSim/src/underwater_simulation/dynamics_stack/unit_sim_dynamics_only/Install/data/";
