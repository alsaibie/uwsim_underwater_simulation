...
class Dynamics:
    ...
    def kinematics(self):
        ...
        p_dot = zeros(6)
        p_dot[0:3] = dot(rec, self.v[0:3])        p_dot[3:6] = dot(to, self.v[3:6])
    ...
    def updateCollision(self, force):
        self.collisionForce = [force.wrench.force.x, force.wrench.force.y, force.wrench.force.z, force.wrench.torque.x,
